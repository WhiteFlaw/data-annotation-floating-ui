...
import { boxEditorUiTemplate } from './template/boxEditorUiTemplate'
import { batchEditorToolsTemplate } from './template/batchEditorToolsTemplate'
...
function BoxEditorManager(parentUi, viewManager, objectTrackView,
  ...
  this.allocateEditor = function() {
    if (this.activeIndex >= this.editorList.length) {
      const editor = new BoxEditor(this.boxEditorGroupUi, this, this.viewManager, cfg, this.boxOp, func_on_box_changed, func_on_box_remove, String(this.activeIndex))
