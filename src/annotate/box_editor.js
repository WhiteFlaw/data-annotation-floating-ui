...
import { boxEditorUiTemplate } from './template/boxEditorUiTemplate.js';
import { batchEditorToolsTemplate } from './template/batchEditorToolsTemplate.js';
...
function BoxEditor(parentUi, boxEditorManager, viewManager, cfg, boxOp, 
    ...
    innerDOMString(boxEditorUiTemplate, parentUi);
...
function BoxEditorManager(parentUi, viewManager, objectTrackView, 
    ...
    this._addToolBox = function(){
        ...
        innerDOMString(batchEditorToolsTemplate, dynamicButtonsPlaceHolder);
