      ...
      <template slot-scope="scope">
        ...
        <span class="el-progress-class progress-container">
          ...
          <el-progress
            ...
            "
            :format="progressBarText(((scope.row.taskCount - scope.row.toBeClaimedCount) || 0), scope.row.taskCount)" />
        </span>
        <span class="el-progress-class progress-container">
          ...
          <el-progress
            :percentage="
              scope.row.firstInspectionCount
                ...
                : 0
            "
            :format="progressBarText(scope.row.firstInspectingCount, scope.row.firstInspectionCount)" />
        </span>
        <span class="el-progress-class progress-container">
          ...
          <el-progress
            :percentage="
              scope.row.secondInspectionCount
                ...
                : 0
            "
            :format="progressBarText(scope.row.secondInspectingCount, scope.row.secondInspectionCount)" />
        </span>
        <span class="el-progress-class progress-container">
